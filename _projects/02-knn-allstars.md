...
highlights:
    - Performed data cleaning 30+ years of NBA data, hyperparameter tuning, and cross validation using Pandas, Scikit-learn 
findings:
    ...
    - Identified "underrated" players (false positives), like Shai Gilgeous-Alexander, and "overrated" players (false negatives), like Rudy Gobert, of the 2021-22 season to show potential flaws and inconsistencies in the current voting process. 
skills:
